(function(){
    ...
    */
    ...
    assessmentButton.onclick = () => {
        ...
        if (userName.length === 0) { // 名前が空白の時は処理を終了する ＊ガード句
            return;
        }
        console.log(userName);
        // TODO 診断結果表示エリア作成
        
        removeAllChildren(resultDivided); // リザルトエリアの子を掃除
        ...
        // TODO ツイートエリア作成
        removeAllChildren(tweetDivided); // ツイートエリアの子を掃除
        ...
        const hrefValue = 'https://twitter.com/intent/tweet?button_hashtag=%E3%81%82%E3%81%AA%E3%81%9F%E3%81%AE%E3%81%84%E3%81%84%E3%81%A8%E3%81%93%E3%82%8D&text='
            + encodeURIComponent(result); // ツイート内容に診断結果を反映　
